...
- 🏆 **LeetCode** - Solve Around 330 Problem on Leetcode.
...
📍 **Harcourt Butler Technical University, Kanpur (HBTU)** | **2024** | **CGPA: 8.68**  
- Focused on **Java, Web Development, Databases, and Software Engineering**.  
- Initially built web projects using **React.js and JavaScript, JSP, Servlets, JDBC, and MySQL**.  
- Later transitioned to **Spring Boot**, developing multiple full-stack web applications.  

### 🎓 Bachelor of Science (BSC)  
📍 **AMU Aligarh, Aligarh Muslim University** | **Percentage: 76.80%**  
- Started tech journey by learning **core Subject** and **fundamentals**.  
